...
def main():
    ...
    parser.add_argument(
        "--predictions", type=str, required=True, help="Path to predictions JSON file"
    )
    parser.add_argument(
        "--annotations",
        type=str,
    ...
    parser.add_argument(
        "--no-overwrite", action="store_true", help="Don't overwrite existing dataset"
    )
    ...
    print("\nDataset contains:")
    print("  • Generated captions (your model)")
